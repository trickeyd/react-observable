...
/** @internal */
export type CatchErrorOperator<T> = (onError?: (error: Error, currentValue: Readonly<T>, setter: ObservableSetter<T>) => void) => Observable<T>;
/** @internal */
...
/** @internal */
export type MapEntriesOperator<T> = <P extends string = '$'>({ keys, observablePostfix, }: {
    keys?: (keyof T)[];
    observablePostfix?: P;
...
export interface Observable<T> {
    ...
    combineLatestFrom: <U extends unknown[]>(...observables: {
